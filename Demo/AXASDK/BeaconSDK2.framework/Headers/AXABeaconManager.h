...
// scan ble device
- (void)startFindBleDevices __attribute__((deprecated("This interface has been scheduled for removal in near future. Use - (void)startFindBleDevicesWithServices:(NSArray<CBUUID *> *)serviceUUIDs options:(NSDictionary<NSString *, id> *) options")));

// scan ble device with services
